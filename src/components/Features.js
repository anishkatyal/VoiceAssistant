        ...
        <View style={{ height: hp(60) }} className="space-y-4">
            ...
            <View className="bg-emerald-200 p-4 rounded-xl space-y-2">
                <View className="flex-row items-center space-x-1">
                    <Image source={require('../../assets/chatgptIcon.png')} style={{ width: hp(4), height: hp(4) }} />
            ...
            <View className="bg-purple-200 p-4 rounded-xl space-y-2">
                <View className="flex-row items-center space-x-1">
                    <Image className="rounded-ful" source={require('../../assets/dalleIcon.png')} style={{ height: hp(4), width: hp(4) }} />
            ...
            <View className="bg-cyan-200 p-4 rounded-xl space-y-2">
                <View className="flex-row items-center space-x-1">
                    <Image className="rounded-ful" source={require('../../assets/smartaiIcon.png')} style={{ height: hp(4), width: hp(4) }} />
